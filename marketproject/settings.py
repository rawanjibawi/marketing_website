...
LOGIN_URL='/login/' # if a page you don't have access to (not authorized) you will be redirect it to this page
LOGIN_REDIRECT_URL = '/'
LOGOUT_REDIRECT_URL='/' # when we logout get to this page
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'base/static'), # app name/ static (or name of static folder)

    # Add more paths if needed
]
MEDIA_URL='media/'
MEDIA_ROOT = BASE_DIR/'media' # BASE_DIR represent the path (location) of our project
